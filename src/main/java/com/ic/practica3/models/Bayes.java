...
public class Bayes {
    ...
    public List<Double> calcularMedia(String key) {
        ...
        for (int j = 0; j < clase.size(); j++) {
            double aux1 = clase.get(j).getValor1() * (1.0 / clase.size());
            double aux2 = clase.get(j).getValor2() * (1.0 / clase.size());
            double aux3 = clase.get(j).getValor3() * (1.0 / clase.size());
            double aux4 = clase.get(j).getValor4() * (1.0 / clase.size());
